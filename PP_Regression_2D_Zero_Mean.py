...
def mean_func_zero(c):  # Prior mean function taken as 0 for the entire data range
...
if opt_method == 'nelder-mead':
    initial_param = np.array([10, 10, 10])  # sigma, length and noise - find a good one to reduce iterations
