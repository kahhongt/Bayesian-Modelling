...
"""Methodology for Log-Gaussian Cox Process"""
...
"""Specify rotation matrix for data set before binning"""
...
opt_method = 'latin-hypercube'
matern_v = 3/2  # Define matern_v
xyz_data = (xy_data_coord, histo, matern_v)

if opt_method == 'nelder-mead':
    initial_param = np.array([10, 10, 10, 10])  # sigma, length, noise and prior mean starting point of iteration
...
"""Plot Settings"""
fig_pp = plt.figure(figsize=(20, 10))
